...
#define __setpgid setpgid
#define __getpgrp getpgrp
#define __getgid getgid
#define __getuid getuid
#define __tcsetpgrp tcsetpgrp
#define __close_nocancel close
#define __getrlimit64 getrlimit64
#define __open_nocancel open
#define __fcntl fcntl
#define __fchdir fchdir
#define __setsid setsid
...
#define __sched_setparam sched_setparam
...
#define local_seteuid seteuid
#define local_setegid setegid
#define __execvpex execvpe
#define __execve execve

// in lieu of <stackinfo.h>
#define _STACK_GROWS_DOWN	1
#include <elf.h>
static int _dl_stack_flags = (PF_R|PF_W|PF_X);
static const int _dl_pagesize = _SC_PAGESIZE;
#define GL(name) _##name
#define GLRO(name) _##name

/* Return is sig is used internally.  */
static inline bool
__is_internal_signal (int sig __attribute__((__unused__)))
{
  return false;
}

static int
__libc_signal_block_all(sigset_t *oldmask)
{
    sigset_t all;
    sigfillset(&all);
    return sigprocmask(SIG_BLOCK, &all, oldmask);
}

static int
__libc_signal_restore_set(sigset_t *oldmask)
{
...
{
  if (false // SHLIB_COMPAT (libc, GLIBC_2_2, GLIBC_2_15)
